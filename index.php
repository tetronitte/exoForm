...
<html>
    ...
    <body>
        <?php if(isset($_SESSION['formSend'])) echo $_SESSION['formSend']; ?>
        <form action="http://localhost/exoForm/controller/form_controller.php" method="POST">
            <div class="panneau-deroulant-1" id="panneau1">
                ...
                <div class="row-form">
                    ...
                    <img src="http://localhost/exoForm/assets/img/error.png" title="" alt="Erreur sur la date de naissance" width="30" height='30' <?php if((isset($_SESSION['error']) && !in_array(3,$_SESSION['error'])) || empty($_SESSION['error'])) echo 'hidden'; ?>>
                </div>
                <div class="row-form">
            ...
            <div class="panneau-deroulant-2" id="panneau2">
                ...
                <div class="row-form">
                    ...
                    <img src="http://localhost/exoForm/assets/img/error.png" title="<?php if(isset($_SESSION['adressError'])) echo $_SESSION['adressError'] ?>" width="30px" height='30px' <?php if((isset($_SESSION['error']) && !in_array(6,$_SESSION['error'])) || empty($_SESSION['error'])) echo 'hidden'; ?>>
                </div>
                <div class="row-form">
